...
//    if (characteristics.lastValue.length > 0) {
//    return
//      StreamBuilder<List<int>>(
//          stream: service.value,
//          initialData: characteristics.lastValue,
//          builder: (c, snapshot) {
...
//              child: DataTable(
//                columns: [
//                  DataColumn(label: Text('Bluetooth')),
...
////  final BluetoothCharacteristic characteristic;   //will be initialized to services.characteristics in main
////
////  const CharacteristicTile(
////      {Key key,
////        this.characteristic,
